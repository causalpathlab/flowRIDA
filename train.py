...
params = {'device': 'cuda', 'input_dim': adata.shape[1],'latent_dim': 15, 'layers': [1000,500,100,15], 'learning_rate': 0.001, 'epochs':1000,'batch_size':128}


gcan_object.set_nn_params(params)
gcan_object.train()
gcan_object.eval(device='cuda',eval_batch_size=1000)
